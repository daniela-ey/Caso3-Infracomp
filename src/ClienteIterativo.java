...
public class ClienteIterativo extends Thread {
    ...
    public ClienteIterativo(PublicKey llavePublicaServidorA) {
        ...
        try (Socket socket = new Socket(SERVIDOR_IP, PUERTO);
           ...
           // Generar DH cliente
            ...
            if (!Arrays.equals(hmacResp, mac.doFinal(paqueteResp))) {
                ...
                out.writeObject("ERROR"); // 18  “OK” final (opcional)
                return;
            } 
            ...
            out.writeObject("OK");
            System.out.println("[" + getName() + "] Finalizado correctamente después de 32 consultas.");
